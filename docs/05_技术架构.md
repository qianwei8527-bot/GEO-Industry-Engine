...
Frontend (Next.js)
   │ REST API / WebSocket
GEO Context Layer
   │ Context Engine · MCP Server · Industry Memory · Context API
   │
API Gateway (FastAPI)
...
## GEO Context Layer（上下文层）

在API网关与业务服务之间新增GEO Context Layer，作为AI Agent获取产业上下文的标准入口。详见 [33_GEO产业上下文层.md](33_GEO产业上下文层.md)。
