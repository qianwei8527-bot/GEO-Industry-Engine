...
related_docs: [CTO长期开发协议, 02-1, 01, 03]
---
﻿# GEO产业引擎 — 领域模型设计
...
| 06_前端信息架构设计.md — 领域对象决定页面展示 | (数据来源) |
...
> Content from 02_领域模型设计.md, integrated for developer reference.

# 02_领域模型设计.md - Sprint 1 Domain Model
