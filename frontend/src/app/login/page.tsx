...
export default function LoginPage() {
  return (
    <div className="max-w-sm mx-auto px-4 py-20">
      <h1 className="text-2xl font-bold text-center text-gray-900 mb-8">{'登录 GEO 产业引擎'}</h1>
      <div className="space-y-4">
        ...
        <button className="w-full bg-blue-600 text-white py-2.5 rounded-lg text-sm font-medium hover:bg-blue-700">{'登录'}</button>
        <p className="text-center text-sm text-gray-500">{'还没有账号？'} <Link href="/register" className="text-blue-600 hover:underline">{'注册'}</Link></p>
          {/* GEO Ecosystem */}
