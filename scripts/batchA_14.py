...
# ===== 14: Entity Intelligence + Information Supply Chain =====
content14 = """# GEO实体智能与信息供应链模型
...
filepath14 = os.path.join("D:\\GEO-IE", "docs", "14_GEO实体智能与信息供应链模型.md")
with open(filepath14, "w", encoding="utf-8") as f:
    f.write(content14)
print("14 created")